...
export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Canva Integration"],
  summary: "Start Canva OAuth flow",
  description: "Initiates the Canva OAuth authorization flow with PKCE",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Canva Integration"],
  summary: "Handle Canva OAuth callback",
  description: "Completes the Canva OAuth flow and activates the connector",
  request: {
    body: {
      content: {
