...
export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Panopto Integration"],
  summary: "Start Panopto OAuth flow",
  description: "Initiates the Panopto OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Panopto Integration"],
  summary: "Handle Panopto OAuth callback",
  description: "Completes the Panopto OAuth flow and activates the connector",
  request: {
    body: {
      content: {
