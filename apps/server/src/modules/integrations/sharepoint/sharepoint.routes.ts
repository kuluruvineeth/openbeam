...
export const startOAuthRoute = createRoute({
  ...
  summary: "Start SharePoint OAuth flow",
  description:
    "Initiates the SharePoint OAuth authorization flow via Microsoft identity platform",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  description:
    "Completes the SharePoint OAuth flow and activates the connector",
  request: {
    body: {
      content: {
        "application/json": {
