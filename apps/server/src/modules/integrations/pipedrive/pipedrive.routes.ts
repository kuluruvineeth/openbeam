...
export const startOAuthRoute = createRoute({
  ...
  summary: "Start Pipedrive OAuth flow",
  description: "Initiates the Pipedrive OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Pipedrive Integration"],
  summary: "Handle Pipedrive OAuth callback",
  description: "Completes the Pipedrive OAuth flow and activates the connector",
  request: {
    body: {
      content: {
