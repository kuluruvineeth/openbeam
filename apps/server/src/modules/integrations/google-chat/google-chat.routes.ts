...
} from "./google-chat.schema";

export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Google Chat Integration"],
  summary: "Start Google Chat OAuth flow",
  description: "Initiates the Google Chat OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Google Chat Integration"],
  summary: "Handle Google Chat OAuth callback",
  description:
    "Completes the Google Chat OAuth flow and activates the connector",
  request: {
    body: {
      content: {
