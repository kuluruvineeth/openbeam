...
export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Dropbox Integration"],
  summary: "Start Dropbox OAuth flow",
  description: "Initiates the Dropbox OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Dropbox Integration"],
  summary: "Handle Dropbox OAuth callback",
  description: "Completes the Dropbox OAuth flow and activates the connector",
  request: {
    body: {
      content: {
