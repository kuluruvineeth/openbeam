...
export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Egnyte Integration"],
  summary: "Start Egnyte OAuth flow",
  description: "Initiates the Egnyte OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Egnyte Integration"],
  summary: "Handle Egnyte OAuth callback",
  description: "Completes the Egnyte OAuth flow and activates the connector",
  request: {
    body: {
      content: {
