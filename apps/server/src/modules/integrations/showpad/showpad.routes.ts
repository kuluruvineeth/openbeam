...
export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Showpad Integration"],
  summary: "Start Showpad OAuth flow",
  description: "Initiates the Showpad OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Showpad Integration"],
  summary: "Handle Showpad OAuth callback",
  description: "Completes the Showpad OAuth flow and activates the connector",
  request: {
    body: {
      content: {
