...
} from "./servicenow.schema";

export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["ServiceNow Integration"],
  summary: "Start ServiceNow OAuth flow",
  description: "Initiates the ServiceNow OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["ServiceNow Integration"],
  summary: "Handle ServiceNow OAuth callback",
  description:
    "Completes the ServiceNow OAuth flow and activates the connector",
  request: {
    body: {
      content: {
