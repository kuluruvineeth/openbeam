...
export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Figma Integration"],
  summary: "Start Figma OAuth flow",
  description: "Initiates the Figma OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  description: "Completes the Figma OAuth flow and activates the connector",
  request: {
    body: {
      content: {
