...
export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["OneNote Integration"],
  summary: "Start OneNote OAuth flow",
  description:
    "Initiates the OneNote OAuth authorization flow via Microsoft identity platform",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["OneNote Integration"],
  summary: "Handle OneNote OAuth callback",
  description: "Completes the OneNote OAuth flow and activates the connector",
  request: {
    body: {
      content: {
        "application/json": {
