...
export const OAuthCallbackResponseSchema = z.object({
  ...
  name: z.string().optional().openapi({
    ...
    example: "Google Drive (user@example.com)",
  }),
  redirectUrl: z.url().optional().openapi({
...
export const ServiceAccountAuthBodySchema = z.object({
  connectorId: z.string().openapi({
  ...
  credentials: z.string().optional().openapi({
    description:
      "Service account JSON credentials (optional if already configured)",
  }),
  delegatedEmail: z.email().optional().openapi({
    description:
      "Admin email for domain-wide delegation (optional if already configured)",
    example: "admin@example.com",
  }),
});

export const ServiceAccountAuthResponseSchema = z.object({
  success: z.boolean(),
  connectorId: z.string().optional().openapi({
  ...
  name: z.string().optional().openapi({
    ...
    example: "Google Drive (admin@example.com)",
  }),
  message: z.string().optional().openapi({
    description: "Error message if success is false",
  }),
