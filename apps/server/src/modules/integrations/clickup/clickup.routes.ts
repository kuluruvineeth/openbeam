...
export const startOAuthRoute = createRoute({
  ...
  description: "Initiates the ClickUp OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["ClickUp Integration"],
  summary: "Handle ClickUp OAuth callback",
  description: "Completes the ClickUp OAuth flow and creates a connector",
  request: {
    body: {
      content: {
