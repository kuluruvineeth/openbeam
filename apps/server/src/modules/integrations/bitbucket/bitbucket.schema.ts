...
export const OAuthCallbackBodySchema = z.object({
  code: z.string().openapi({
    description: "OAuth authorization code from Bitbucket",
    example: "abc123",
  }),
...
export const OAuthStartResponseSchema = z.object({
  ...
  oauthUrl: z.url().optional().openapi({
    description: "Bitbucket OAuth authorization URL",
    example: "https://bitbucket.org/site/oauth2/authorize?...",
  }),
