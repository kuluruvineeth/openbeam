...
export const startOAuthRoute = createRoute({
  ...
  description: "Initiates the Bitbucket OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Bitbucket Integration"],
  summary: "Handle Bitbucket OAuth callback",
  description: "Completes the Bitbucket OAuth flow and activates a connector",
  request: {
    body: {
      content: {
        "application/json": {
