...
export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Intercom Integration"],
  summary: "Start Intercom OAuth flow",
  description: "Initiates the Intercom OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Intercom Integration"],
  summary: "Handle Intercom OAuth callback",
  description: "Completes the Intercom OAuth flow and activates the connector",
  request: {
    body: {
      content: {
