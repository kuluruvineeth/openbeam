...
} from "./highspot.schema";

export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Highspot Integration"],
  summary: "Start Highspot OAuth flow",
  description: "Initiates the Highspot OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Highspot Integration"],
  summary: "Handle Highspot OAuth callback",
  description: "Completes the Highspot OAuth flow and activates the connector",
  request: {
    body: {
      content: {
