...
export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Seismic Integration"],
  summary: "Start Seismic OAuth flow",
  description: "Initiates the Seismic OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Seismic Integration"],
  summary: "Handle Seismic OAuth callback",
  description: "Completes the Seismic OAuth flow and activates the connector",
  request: {
    body: {
      content: {
