...
} from "./dynamics365.schema";

export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Dynamics 365 Integration"],
  summary: "Start Dynamics 365 OAuth flow",
  description:
    "Initiates the Dynamics 365 OAuth authorization flow via Microsoft identity platform",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Dynamics 365 Integration"],
  summary: "Handle Dynamics 365 OAuth callback",
  description:
    "Completes the Dynamics 365 OAuth flow and activates the connector",
  request: {
    body: {
      content: {
        "application/json": {
