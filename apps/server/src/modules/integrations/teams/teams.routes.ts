...
export const startOAuthRoute = createRoute({
  ...
  description:
    "Initiates the Microsoft Teams OAuth authorization flow via Microsoft identity platform",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  description:
    "Completes the Microsoft Teams OAuth flow and activates the connector",
  request: {
    body: {
      content: {
        "application/json": {
