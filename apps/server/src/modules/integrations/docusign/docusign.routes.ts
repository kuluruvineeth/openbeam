...
} from "./docusign.schema";

export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["DocuSign Integration"],
  summary: "Start DocuSign OAuth flow",
  description: "Initiates the DocuSign OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  description: "Completes the DocuSign OAuth flow and activates the connector",
  request: {
    body: {
      content: {
