...
export const startOAuthRoute = createRoute({
  ...
  summary: "Start Procore OAuth flow",
  description: "Initiates the Procore OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Procore Integration"],
  summary: "Handle Procore OAuth callback",
  description: "Completes the Procore OAuth flow and activates the connector",
  request: {
    body: {
      content: {
