...
} from "./google-sites.schema";

export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Google Sites Integration"],
  summary: "Start Google Sites OAuth flow",
  description: "Initiates the Google Sites OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Google Sites Integration"],
  summary: "Handle Google Sites OAuth callback",
  description:
    "Completes the Google Sites OAuth flow and activates the connector",
  request: {
    body: {
      content: {
        "application/json": {
