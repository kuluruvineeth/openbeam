...
export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Airtable Integration"],
  summary: "Start Airtable OAuth flow",
  description: "Initiates the Airtable OAuth authorization flow with PKCE",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Airtable Integration"],
  summary: "Handle Airtable OAuth callback",
  description: "Completes the Airtable OAuth flow and activates the connector",
  request: {
    body: {
      content: {
