...
export const startOAuthRoute = createRoute({
  method: "get",
  path: "/oauth/start",
  tags: ["Zendesk Integration"],
  summary: "Start Zendesk OAuth flow",
  description: "Initiates the Zendesk OAuth authorization flow",
  request: {
...
export const oauthCallbackRoute = createRoute({
  ...
  path: "/callback",
  tags: ["Zendesk Integration"],
  summary: "Handle Zendesk OAuth callback",
  description: "Completes the Zendesk OAuth flow and activates the connector",
  request: {
    body: {
      content: {
