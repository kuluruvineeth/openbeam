...
export const searchQuerySchema = z.object({
  ...
  document_type: z.string().optional().openapi({
    description: "Filter by document type (e.g., message, file, page)",
    example: "message",
  }),
  ...
  from_date: z.coerce.number().optional().openapi({
    description: "Filter documents from this timestamp (Unix epoch)",
  }),
  to_date: z.coerce.number().optional().openapi({
    description: "Filter documents until this timestamp (Unix epoch)",
  }),
