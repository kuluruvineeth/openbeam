...
describe("findProjectIcon", () => {
  ...
  it("finds icon in nested priority directory", async () => {
    ...
    writeFileSync(
      join(tempDir, "public", "images", "favicon.png"),
      "nested icon"
    );
  ...
  describe("monorepo package directories", () => {
    it("finds icon in packages/*/public directory", async () => {
      mkdirSync(join(tempDir, "packages", "app", "public"), {
        recursive: true,
      });
      writeFileSync(
        join(tempDir, "packages", "app", "public", "favicon.ico"),
        "icon"
      );
    ...
    it("finds icon in apps/*/public directory", async () => {
      ...
      writeFileSync(
        join(tempDir, "apps", "web", "public", "favicon.png"),
        "icon"
      );
