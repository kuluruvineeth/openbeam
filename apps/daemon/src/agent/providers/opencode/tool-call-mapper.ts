...
const OpencodeNormalizedToolCallPass1Schema =
  OpencodeRawToolCallSchema.transform((raw) => {
...
function toToolCallTimelineItem(
  normalized: OpencodeToolCallPass2
...
export function mapOpencodeToolCall(
  params: OpencodeToolCallParams
  ...
  const pass2Envelope = OpencodeToolCallPass2EnvelopeSchema.safeParse(
    pass1.data
  );
