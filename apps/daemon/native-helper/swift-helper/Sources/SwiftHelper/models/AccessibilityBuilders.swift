...
struct GetAccessibilityStatusResult: Codable {
    /// Is accessibility permission currently granted?
    let granted: Bool
    /// Whether the app can still prompt/open System Settings for this permission.
    let promptable: Bool?
...
struct RequestAccessibilityPermissionResult: Codable {
    ...
    let granted: Bool
    /// Whether System Settings was opened to let the user grant permission.
    let openedSystemSettings: Bool?
}
