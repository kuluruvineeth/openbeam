...
function getModeColor(modeId?: string): string {
  ...
  if (modeId.includes("ask")) {
    return "#f59e0b"; // orange - asks permission
  }
  if (modeId.includes("code")) {
    return "#22c55e"; // green - writes code
  }
  if (modeId.includes("architect") || modeId.includes("plan")) {
    return "#3b82f6"; // blue - plans
  }
