...
export function VolumeMeter({
  ...
  useEffect(() => {
    ...
    isMuted, // Animate each dot with different phases and durations
    line1Pulse,
    line2Pulse,
    line3Pulse,
  ]);
  ...
  useEffect(() => {
    ...
    isMuted,
    MAX_HEIGHT,
    MIN_HEIGHT, // No volume - return to minimum
    line1Height,
    line2Height,
    line3Height,
  ]);
  ...
  const line1Style = useAnimatedStyle(() => {
    ...
    return {
      height:
        line1Height.value * (isMuted || volume > 0.001 ? 1 : line1Pulse.value),
  ...
  const line2Style = useAnimatedStyle(() => {
    ...
    return {
      height:
        line2Height.value * (isMuted || volume > 0.001 ? 1 : line2Pulse.value),
      opacity: baseOpacity + volumeBoost,
    };
  });
  ...
  const line3Style = useAnimatedStyle(() => {
    ...
    return {
      height:
        line3Height.value * (isMuted || volume > 0.001 ? 1 : line3Pulse.value),
      opacity: baseOpacity + volumeBoost,
    };
  });
