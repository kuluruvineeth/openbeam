...
function GroupedTextItem({ item }: { item: GroupedTextMessage }) {
  ...
  return (
    <View style={[stylesheet.card, isThought && stylesheet.thoughtCard]}>
      <Text
        style={[stylesheet.timestamp, isThought && stylesheet.thoughtTimestamp]}
      >
      ...
      >
        <View style={stylesheet.toolHeaderLeft}>
          ...
          <View style={stylesheet.toolTitleRow}>
            <Text style={stylesheet.toolIcon}>
...
export function AgentActivityItem({ item }: AgentActivityItemProps) {
  ...
  // Tasks
  if (update.kind === "plan") {
    return <PlanItem timestamp={activity.timestamp} update={update} />;
  }
  ...
  return <UnknownActivityItem timestamp={activity.timestamp} update={update} />;
}
