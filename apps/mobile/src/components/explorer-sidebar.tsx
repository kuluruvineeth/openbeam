      ...
      Gesture.Pan()
        ...
        .onUpdate((event) => {
          ...
          const newTranslateX = Math.max(
            0,
            Math.min(windowWidth, event.translationX)
          );
  ...
  return (
    <View pointerEvents="auto" style={styles.sidebarContent}>
        ...
        <View style={styles.tabsContainer}>
          {isGit && (
            <Pressable
              ...
              style={[
                styles.tab,
                resolvedTab === "changes" && styles.tabActive,
              ]}
          ...
          <Pressable
            ...
            style={[
              styles.tab,
              resolvedTab === "terminals" && styles.tabActive,
            ]}
      ...
      <View style={styles.contentArea} testID="explorer-content-area">
        {resolvedTab === "changes" && (
          <GitDiffPane agentId={agentId} cwd={cwd} serverId={serverId} />
        )}
        {resolvedTab === "files" && (
          <FileExplorerPane agentId={agentId} serverId={serverId} />
        )}
        {resolvedTab === "terminals" && (
          <TerminalPane cwd={cwd} serverId={serverId} />
        )}
      </View>
    </View>
  );
