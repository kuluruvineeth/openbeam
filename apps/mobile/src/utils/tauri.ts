...
export interface TauriGlobalShortcutApi {
  register?: (
    shortcut: string,
    handler: (event: {
      shortcut: string;
  ...
  unregisterAll?: (shortcuts?: string[]) => Promise<void>;
  isRegistered?: (shortcut: string) => Promise<boolean>;
}

export interface TauriGlobalShortcutModule {
  register?: TauriGlobalShortcutApi["register"];
  registerAll?: TauriGlobalShortcutApi["registerAll"];
  unregister?: TauriGlobalShortcutApi["unregister"];
  unregisterAll?: TauriGlobalShortcutApi["unregisterAll"];
  isRegistered?: TauriGlobalShortcutApi["isRegistered"];
}
