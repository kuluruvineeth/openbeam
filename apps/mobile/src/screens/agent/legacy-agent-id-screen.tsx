...
export function LegacyAgentIdScreen({ agentId }: { agentId: string }) {
  ...
  const resolvedAgentId =
    typeof agentId === "string" ? agentId.trim() : undefined;
  ...
  useEffect(() => {
    ...
    router.replace(
      ...
      buildHostAgentDetailRoute(match.serverId, match.agent.id) as any
    );
  ...
  if (!resolvedAgentId) {
    body = (
      <View style={styles.centerState}>
        ...
        <Text style={styles.subtitle}>
          This link is missing an agent id. Go back to the Agents screen to pick
          one.
        </Text>
        <Pressable onPress={handleGoDraft} style={styles.primaryButton}>
    ...
    body = (
      <View style={styles.centerState}>
        ...
        <Text style={styles.subtitle}>
          We could not find {resolvedAgentId} on any host right now. Hosts
          reconnect automatically—open it again from the Agents screen after it
          comes back online.
        </Text>
        <Pressable onPress={handleGoDraft} style={styles.primaryButton}>
          <Text style={styles.primaryButtonText}>New agent</Text>
    ...
    body = (
      <View style={styles.centerState}>
        ...
        <Text style={styles.subtitle}>
          Multiple hosts have an agent with this id. Choose the one you intended
          to open.
        </Text>
  ...
  return (
    <View style={styles.container}>
      <BackHeader onBack={handleGoDraft} title="Agent" />
