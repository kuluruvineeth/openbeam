...
const KNOWN_APP_LOGOS: Record<string, React.ReactNode> = {
  claude: (
    <svg
      aria-hidden="true"
    ...
    >
      <rect fill="#D97757" height="36" rx="4" width="36" />
  ...
  chatgpt: (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <rect fill="#412991" height="36" rx="4" width="36" />
      <g transform="translate(6,6) scale(1)">
        <path
...
function getKnownLogo(name: string): React.ReactNode | null {
  const normalized = name.toLowerCase().trim();
  return KNOWN_APP_LOGOS[normalized] ?? null;
}
