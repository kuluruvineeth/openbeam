...
const components: Components = {
  ...
  img: ({ src, alt }) => (
    // biome-ignore lint/performance/noImgElement: Dynamic markdown content, dimensions unknown
    // biome-ignore lint/correctness/useImageSize: Dynamic markdown content, dimensions unknown
    <img alt={alt ?? ""} className="inline-block max-w-full" src={src} />
  ),
  div: ({ node, children, style, ...props }) => {
