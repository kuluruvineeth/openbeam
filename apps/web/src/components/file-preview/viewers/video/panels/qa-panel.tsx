...
import { Button, Input, ScrollArea } from "@openplane/ui";
...
export function QAPanel({ onAsk, onSeek, isAsking }: QAPanelProps) {
    ...
    <div className={cn("flex", isUser ? "justify-end" : "justify-start")}>
      <div
        className={cn(
          ...
          isUser ? "bg-primary text-primary-foreground" : "bg-foreground/[0.04]"
        )}
      >
...
function TypingIndicator() {
  return (
    <div className="flex justify-start">
      <div className="flex gap-1 bg-foreground/[0.04] px-2.5 py-2">
