...
export const Icons = {
  ...
  Layers: createIcon(LayersIcon),
  LogOut: createIcon(Logout01Icon),
  FileExport: createIcon(FileExportIcon),
  AlertTriangle: createIcon(Alert02Icon),
  Circle: LucideCircle,
  MoreHorizontal: LucideMoreHorizontal,
  Mic: createIcon(Mic01Icon),
  Film: createIcon(VideoReplayIcon),
  Sparkles: createIcon(SparklesIcon),
  ImageIcon: createIcon(ImageIcon),
  Clipboard: createIcon(ClipboardIcon),
  Coins: createIcon(Coins01Icon),
  TrendingDown: createIcon(AnalyticsDownIcon),
  TrendingUp: createIcon(AnalyticsUpIcon),
  Wand: createIcon(MagicWand01Icon),
  Magnet: createIcon(MagnetIcon),
  Keyboard: createIcon(KeyboardIcon),
  FileInput: createIcon(FileImportIcon),
  Clapperboard: createIcon(Film01Icon),
  Expand: createIcon(Maximize01Icon),
  Volume2: createIcon(VolumeHighIcon),
  VolumeX: createIcon(VolumeMute01Icon),
  Speaker: createIcon(VolumeHighIcon),
  Loader2: createIcon(Loading01Icon),
  Bot: createIcon(RobotIcon),
  Grid3x3: createIcon(GridIcon),
  CheckCircle: createIcon(CheckmarkCircle01Icon),
  BrainCircuit: createIcon(BrainIcon),
  Code2: createIcon(SourceCodeIcon),
  FileText: createIcon(DocumentCodeIcon),
