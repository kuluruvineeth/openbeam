...
export const Icons = {
  ...
  DrawingMode: createIcon(DrawingModeIcon),
  Eraser: createIcon(EraserIcon),
  LassoTool: createIcon(LassoToolIcon),
  RectangleSelect: createIcon(CursorRectangleSelectionIcon),
  ...
  MicOff: createIcon(MicOff01Icon),
  ...
  AlignLeft: createIcon(TextIcon),
  List: createIcon(Menu01Icon),
  Briefcase: createIcon(ToolsIcon),
  MessageCircle: createIcon(Message01Icon),
  Target: createIcon(Target01Icon),
  Quote: createIcon(Comment01Icon),
  CheckSquare: createIcon(CheckmarkCircle01Icon),
  BarChart: createIcon(AnalyticsUpIcon),
  Building: createIcon(Building01Icon),
  MapPin: createIcon(Location01Icon),
  DollarSign: createIcon(Dollar01Icon),
  Percent: createIcon(PercentIcon),
  Phone: createIcon(CallIcon),
  Link: createIcon(LinkIcon),
  ListTree: createIcon(HierarchyIcon),
  Lightbulb: createIcon(Idea01Icon),
  Receipt: createIcon(Invoice01Icon),
  Scale: createIcon(JusticeScale01Icon),
  Package: createIcon(Package01Icon),
  UserPlus: createIcon(UserAdd01Icon),
  CalendarDays: createIcon(Calendar01Icon),
  GripVertical: createIcon(DragDropVerticalIcon),
  Type: createIcon(TextFontIcon),
  ToggleLeft: createIcon(ToggleOnIcon),
  Hash2: createIcon(GridIcon),
  Number: createIcon(GridIcon),
  Timer: createIcon(StopWatchIcon),
  XCircle: createIcon(CancelCircleIcon),
  Ban: createIcon(CancelCircleIcon),
  Tag: createIcon(Tag01Icon),
  CornerDownRight: createIcon(ArrowTurnBackwardIcon),
  FormInput: createIcon(FileImportIcon),
  GanttChart: createIcon(DistributeHorizontalCenterIcon),
  FilterX: createIcon(FilterRemoveIcon),
  X: createIcon(Cancel01Icon),
  Archive: createIcon(Archive01Icon),
  ArrowDown: createIcon(ArrowDownIcon),
  ArrowUp: createIcon(ArrowUpIcon),
  ArrowUpDown: createIcon(ArrowDataTransferDiagonalIcon),
  Bookmark: createIcon(Bookmark01Icon),
  Edit2: createIcon(PencilEdit01Icon),
  Edit3: createIcon(PencilEdit01Icon),
  File: createIcon(File01Icon),
  LayoutGrid: createIcon(GridIcon),
  Paperclip: createIcon(Attachment01Icon),
  PaperclipIcon: createIcon(Attachment01Icon),
  ShieldAlert: createIcon(ShieldIcon),
  Star: createIcon(FavouriteIcon),
  Trash2: createIcon(Delete01Icon),
  ChevronsUpDown: createIcon(ArrowDataTransferDiagonalIcon),
  CircleDot: createIcon(SquareIcon),
  FolderSearch: createIcon(FolderSearchIcon),
  FileSearch: createIcon(SearchIcon),
  Home: createIcon(Home01Icon),
  Terminal: createIcon(ToolsIcon),
  Moon: LucideMoon,
  Sun: LucideSun,
