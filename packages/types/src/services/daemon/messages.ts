...
const ToolCallDetailPayloadSchema: z.ZodType<ToolCallDetail> =
...
const ToolCallTimelineItemPayloadSchema: z.ZodType<ToolCallTimelineItem> =
  z.union([
...
export const AgentSnapshotPayloadSchema = z.object({
  ...
  attentionReason: z
    .enum(["finished", "error", "permission"])
    .nullable()
    .optional(),
...
export const DaemonWorktreeListRequestSchema = z.object({
  type: z.literal("daemon_worktree_list_request"),
  cwd: z.string().optional(),
  repoRoot: z.string().optional(),
  requestId: z.string(),
});

export const DaemonWorktreeArchiveRequestSchema = z.object({
  type: z.literal("daemon_worktree_archive_request"),
...
const NativeHelperMethodSchema = z.enum(
  Object.keys(NativeHelperMethodSchemas) as [
    NativeHelperRpcMethod,
    ...NativeHelperRpcMethod[],
  ]
);

const NativeHelperCallRequestBaseSchema = z.object({
  type: z.literal("native_helper_call_request"),
  requestId: z.string(),
});

const NativeHelperCallRequestSchemas = [
  NativeHelperCallRequestBaseSchema.extend({
    method: z.literal("getAccessibilityStatus"),
    params: NativeHelperMethodSchemas.getAccessibilityStatus.params,
  }),
  NativeHelperCallRequestBaseSchema.extend({
    method: z.literal("requestAccessibilityPermission"),
    params: NativeHelperMethodSchemas.requestAccessibilityPermission.params,
  }),
  NativeHelperCallRequestBaseSchema.extend({
    method: z.literal("getAccessibilityContext"),
    params: NativeHelperMethodSchemas.getAccessibilityContext.params,
  }),
  NativeHelperCallRequestBaseSchema.extend({
    method: z.literal("getAccessibilityTreeDetails"),
    params: NativeHelperMethodSchemas.getAccessibilityTreeDetails.params,
  }),
  NativeHelperCallRequestBaseSchema.extend({
    method: z.literal("pasteText"),
    params: NativeHelperMethodSchemas.pasteText.params,
  }),
  NativeHelperCallRequestBaseSchema.extend({
    method: z.literal("muteSystemAudio"),
    params: NativeHelperMethodSchemas.muteSystemAudio.params,
  }),
  NativeHelperCallRequestBaseSchema.extend({
    method: z.literal("restoreSystemAudio"),
    params: NativeHelperMethodSchemas.restoreSystemAudio.params,
  }),
  NativeHelperCallRequestBaseSchema.extend({
    method: z.literal("setShortcuts"),
    params: NativeHelperMethodSchemas.setShortcuts.params,
  }),
  NativeHelperCallRequestBaseSchema.extend({
    method: z.literal("recheckPressedKeys"),
    params: NativeHelperMethodSchemas.recheckPressedKeys.params,
  }),
] as const;

export const NativeHelperCallRequestSchema = z.discriminatedUnion(
  "method",
  NativeHelperCallRequestSchemas
);

const NativeHelperCallRequestParamsSchema = z.union([
  NativeHelperMethodSchemas.getAccessibilityStatus.params,
  NativeHelperMethodSchemas.requestAccessibilityPermission.params,
  NativeHelperMethodSchemas.getAccessibilityContext.params,
  NativeHelperMethodSchemas.getAccessibilityTreeDetails.params,
  NativeHelperMethodSchemas.pasteText.params,
  NativeHelperMethodSchemas.muteSystemAudio.params,
  NativeHelperMethodSchemas.restoreSystemAudio.params,
  NativeHelperMethodSchemas.setShortcuts.params,
  NativeHelperMethodSchemas.recheckPressedKeys.params,
]);

const NativeHelperCallRequestSessionSchema =
  NativeHelperCallRequestBaseSchema.extend({
    method: NativeHelperMethodSchema,
    params: NativeHelperCallRequestParamsSchema,
  });
...
export const SessionInboundMessageSchema = z.discriminatedUnion("type", [
  ...
  DaemonWorktreeListRequestSchema,
  DaemonWorktreeArchiveRequestSchema,
  ...
  PingMessageSchema,
  NativeHelperCallRequestSessionSchema,
...
const ServerInfoVersionSchema = z
  .unknown()
  .transform((value): string | null => {
    if (typeof value !== "string") {
      return null;
...
export const ProjectCheckoutLiteNotGitPayloadSchema = z.object({
  ...
  remoteUrl: z.null(),
  isDaemonOwnedWorktree: z.literal(false),
  mainRepoRoot: z.null(),
});

export const ProjectCheckoutLiteGitNonDaemonPayloadSchema = z.object({
  cwd: z.string(),
...
export const ProjectCheckoutLiteGitDaemonPayloadSchema = z.object({
  cwd: z.string(),
  isGit: z.literal(true),
  currentBranch: z.string().nullable(),
  remoteUrl: z.string().nullable(),
  isDaemonOwnedWorktree: z.literal(true),
  mainRepoRoot: z.string(),
});

export const ProjectCheckoutLitePayloadSchema = z.union([
  ProjectCheckoutLiteNotGitPayloadSchema,
  ProjectCheckoutLiteGitNonDaemonPayloadSchema,
  ProjectCheckoutLiteGitDaemonPayloadSchema,
]);
...
const CheckoutStatusGitNonDaemonSchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isDaemonOwnedWorktree: z.literal(false),
  repoRoot: z.string(),
  currentBranch: z.string().nullable(),
...
const CheckoutStatusGitDaemonSchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isDaemonOwnedWorktree: z.literal(true),
  repoRoot: z.string(),
  mainRepoRoot: z.string(),
...
export const CheckoutStatusResponseSchema = z.object({
  ...
  payload: z.union([
    ...
    CheckoutStatusGitNonDaemonSchema,
    CheckoutStatusGitDaemonSchema,
  ]),
});
...
const DaemonWorktreeSchema = z.object({
  worktreePath: z.string(),
  branchName: z.string().nullable().optional(),
  head: z.string().nullable().optional(),
});

export const DaemonWorktreeListResponseSchema = z.object({
  type: z.literal("daemon_worktree_list_response"),
  payload: z.object({
    worktrees: z.array(DaemonWorktreeSchema),
    error: CheckoutErrorSchema.nullable(),
    requestId: z.string(),
  }),
});

export const DaemonWorktreeArchiveResponseSchema = z.object({
  type: z.literal("daemon_worktree_archive_response"),
  payload: z.object({
    success: z.boolean(),
...
export const NativeHelperCallResponseSchema = z.object({
  type: z.literal("native_helper_call_response"),
  payload: z.object({
    requestId: z.string(),
    method: NativeHelperMethodSchema,
    ok: z.boolean(),
...
export const NativeHelperEventMessageSchema = z.object({
  type: z.literal("native_helper_event"),
  payload: NativeHelperEventSchema,
});
...
export const SessionOutboundMessageSchema = z.discriminatedUnion("type", [
  ...
  DaemonWorktreeListResponseSchema,
  DaemonWorktreeArchiveResponseSchema,
  ...
  NativeHelperCallResponseSchema,
  NativeHelperEventMessageSchema,
...
export type TranscriptionResultMessage = z.infer<
...
export type ServerVoiceCapabilities = z.infer<
  typeof ServerVoiceCapabilitiesSchema
>;
export type ServerCapabilities = z.infer<typeof ServerCapabilitiesSchema>;
export type ServerInfoStatusPayload = z.infer<
  typeof ServerInfoStatusPayloadSchema
>;
...
export type ProjectCheckoutLitePayload = z.infer<
  typeof ProjectCheckoutLitePayloadSchema
>;
export type ProjectPlacementPayload = z.infer<
  typeof ProjectPlacementPayloadSchema
>;
...
>;
export type UpdateAgentResponseMessage = z.infer<
...
>;
export type SpeechModelsListResponse = z.infer<
  typeof SpeechModelsListResponseSchema
>;
export type SpeechModelsDownloadResponse = z.infer<
  typeof SpeechModelsDownloadResponseSchema
>;

export type ActivityLogPayload = z.infer<typeof ActivityLogPayloadSchema>;

export type VoiceAudioChunkMessage = z.infer<
  typeof VoiceAudioChunkMessageSchema
>;
export type FetchAgentsRequestMessage = z.infer<
  typeof FetchAgentsRequestMessageSchema
>;
export type FetchAgentRequestMessage = z.infer<
  typeof FetchAgentRequestMessageSchema
>;
...
export type DictationStreamStartMessage = z.infer<
  typeof DictationStreamStartMessageSchema
>;
export type DictationStreamChunkMessage = z.infer<
  typeof DictationStreamChunkMessageSchema
>;
export type DictationStreamFinishMessage = z.infer<
  typeof DictationStreamFinishMessageSchema
>;
export type DictationStreamCancelMessage = z.infer<
  typeof DictationStreamCancelMessageSchema
>;
export type CreateAgentRequestMessage = z.infer<
  typeof CreateAgentRequestMessageSchema
>;
...
>;
export type SpeechModelsListRequestMessage = z.infer<
  typeof SpeechModelsListRequestSchema
>;
...
export type ResumeAgentRequestMessage = z.infer<
  typeof ResumeAgentRequestMessageSchema
>;
export type DeleteAgentRequestMessage = z.infer<
  typeof DeleteAgentRequestMessageSchema
>;
export type UpdateAgentRequestMessage = z.infer<
  typeof UpdateAgentRequestMessageSchema
>;
export type SetAgentModeRequestMessage = z.infer<
  typeof SetAgentModeRequestMessageSchema
>;
export type SetAgentModelRequestMessage = z.infer<
  typeof SetAgentModelRequestMessageSchema
>;
export type SetAgentThinkingRequestMessage = z.infer<
  typeof SetAgentThinkingRequestMessageSchema
>;
export type AgentPermissionResponseMessage = z.infer<
  typeof AgentPermissionResponseMessageSchema
>;
...
export type CheckoutCommitResponse = z.infer<
...
export type CheckoutMergeFromBaseRequest = z.infer<
  typeof CheckoutMergeFromBaseRequestSchema
>;
export type CheckoutMergeFromBaseResponse = z.infer<
...
export type CheckoutPrCreateRequest = z.infer<
  typeof CheckoutPrCreateRequestSchema
>;
export type CheckoutPrCreateResponse = z.infer<
  typeof CheckoutPrCreateResponseSchema
>;
export type CheckoutPrStatusRequest = z.infer<
  typeof CheckoutPrStatusRequestSchema
>;
export type CheckoutPrStatusResponse = z.infer<
  typeof CheckoutPrStatusResponseSchema
>;
export type ValidateBranchRequest = z.infer<typeof ValidateBranchRequestSchema>;
export type ValidateBranchResponse = z.infer<
  typeof ValidateBranchResponseSchema
>;
export type BranchSuggestionsRequest = z.infer<
  typeof BranchSuggestionsRequestSchema
>;
export type BranchSuggestionsResponse = z.infer<
  typeof BranchSuggestionsResponseSchema
>;
export type DirectorySuggestionsRequest = z.infer<
  typeof DirectorySuggestionsRequestSchema
>;
export type DirectorySuggestionsResponse = z.infer<
  typeof DirectorySuggestionsResponseSchema
>;
export type DaemonWorktreeListRequest = z.infer<
  typeof DaemonWorktreeListRequestSchema
>;
export type DaemonWorktreeListResponse = z.infer<
  typeof DaemonWorktreeListResponseSchema
>;
export type DaemonWorktreeArchiveRequest = z.infer<
  typeof DaemonWorktreeArchiveRequestSchema
>;
export type DaemonWorktreeArchiveResponse = z.infer<
  typeof DaemonWorktreeArchiveResponseSchema
>;
...
export type FileDownloadTokenRequest = z.infer<
  typeof FileDownloadTokenRequestSchema
>;
export type FileDownloadTokenResponse = z.infer<
  typeof FileDownloadTokenResponseSchema
>;
export type RestartServerRequestMessage = z.infer<
  typeof RestartServerRequestMessageSchema
>;
export type ClearAgentAttentionMessage = z.infer<
  typeof ClearAgentAttentionMessageSchema
>;
...
export type NativeHelperCallRequestMessage = z.infer<
  typeof NativeHelperCallRequestSchema
>;
export type NativeHelperCallResponse = z.infer<
  typeof NativeHelperCallResponseSchema
>;
export type NativeHelperEventMessage = z.infer<
  typeof NativeHelperEventMessageSchema
>;
export type RegisterPushTokenMessage = z.infer<
  typeof RegisterPushTokenMessageSchema
>;
...
export type SubscribeTerminalsRequest = z.infer<
  typeof SubscribeTerminalsRequestSchema
>;
export type UnsubscribeTerminalsRequest = z.infer<
  typeof UnsubscribeTerminalsRequestSchema
>;
...
>;
export type SubscribeTerminalRequest = z.infer<
  typeof SubscribeTerminalRequestSchema
>;
export type SubscribeTerminalResponse = z.infer<
  typeof SubscribeTerminalResponseSchema
>;
export type UnsubscribeTerminalRequest = z.infer<
  typeof UnsubscribeTerminalRequestSchema
>;
...
export type AttachTerminalStreamRequest = z.infer<
  typeof AttachTerminalStreamRequestSchema
>;
export type AttachTerminalStreamResponse = z.infer<
  typeof AttachTerminalStreamResponseSchema
>;
export type DetachTerminalStreamRequest = z.infer<
  typeof DetachTerminalStreamRequestSchema
>;
export type DetachTerminalStreamResponse = z.infer<
  typeof DetachTerminalStreamResponseSchema
>;
...
export function wrapSessionMessage(
  ...
  return { type: "session", message: sessionMsg };
}
