...
export const SlackRateLimitConfigSchema = z.object({
  requestsPerMinute: z.number().optional(),
  requestsPerHour: z.number().optional(),
  burstLimit: z.number().optional(),
});

export const SlackClientConfigSchema = z.object({
  token: z.string(),
  connectorId: z.string(),
  teamId: z.string().optional(),
  rateLimitConfig: SlackRateLimitConfigSchema.optional(),
  timeout: z.number().optional(),
  debug: z.boolean().optional(),
});

export type SlackClientConfig = z.infer<typeof SlackClientConfigSchema>;
...
export const SyncCursorSchema = z.object({
  ...
  lastFileSyncTimestamp: z.string().optional(),
  lastCanvasSyncTimestamp: z.number().optional(),
  lastClipSyncTimestamp: z.number().optional(),
  lastBookmarkSyncTimestamp: z.number().optional(),
});
...
export const SyncOptionsSchema = z.object({
  ...
  channelTypes: z.array(z.enum(["public", "private", "im", "mpim"])).optional(),
  channelIds: z.array(z.string()).optional(),
});

export type SyncOptions = z.infer<typeof SyncOptionsSchema>;

export const SlackSyncBatchStatsSchema = z.object({
  processed: z.number(),
  skipped: z.number(),
  errors: z.number(),
});

export interface SlackSyncBatch<T> {
  items: T[];
  cursor: SyncCursor;
  hasMore: boolean;
  stats: z.infer<typeof SlackSyncBatchStatsSchema>;
}
...
export const FederatedSearchOptionsSchema = z.object({
  limit: z.number().optional(),
  page: z.number().optional(),
  sort: z.enum(["score", "timestamp"]).optional(),
  sortDir: z.enum(["asc", "desc"]).optional(),
  channelFilter: z.array(z.string()).optional(),
  channelExclude: z.array(z.string()).optional(),
  includeGroupDms: z.boolean().optional(),
  maxAgeDays: z.number().optional(),
});

export type FederatedSearchOptions = z.infer<
