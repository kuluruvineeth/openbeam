...
const BUILTIN_TEMPLATES: SandboxTemplate[] = [
  {
    ...
    image: "ghcr.io/openbeam/sandbox-base:latest",
  ...
  },
  {
    ...
    image: "ghcr.io/openbeam/sandbox-python:latest",
  ...
  },
  {
    ...
    image: "ghcr.io/openbeam/sandbox-node:latest",
  ...
  },
  {
    ...
    image: "ghcr.io/openbeam/sandbox-data-science:latest",
    languages: ["python", "bash"],
    preInstalledPackages: [
      "python3",
      "jupyter",
  ...
  },
  {
    ...
    image: "ghcr.io/openbeam/sandbox-browser:latest",
    languages: ["python", "javascript", "bash"],
  ...
  },
  {
    ...
    image: "ghcr.io/openbeam/sandbox-full:latest",
    languages: ["python", "javascript", "bash"],
    preInstalledPackages: [
      "python3",
      "node",
