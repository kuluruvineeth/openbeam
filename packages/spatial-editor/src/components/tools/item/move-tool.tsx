import type { DoorNode, ItemNode, WindowNode } from "@openbeam/spatial-core";
...
export const MoveTool: React.FC = () => {
  ...
  if (movingNode.type === "door") {
    return <MoveDoorTool node={movingNode as DoorNode} />;
  }
  if (movingNode.type === "window") {
    return <MoveWindowTool node={movingNode as WindowNode} />;
  }
