...
import type { AnyNodeId, CollectionId } from "@openbeam/spatial-core";
                  ...
                  return (
                    ...
                    >
                      ...
                      <input
                        ...
                        onKeyDown={(e) => {
                          if (e.key === "Enter") {
                            handleRenameConfirm(collection.id);
                          }
                          if (e.key === "Escape") {
                            setRenamingId(null);
                          }
                  ...
                  <li key={collection.id}>
                    <div className="group flex items-center gap-2 px-3 py-2 transition-colors hover:bg-white/5">
                      ...
                      <ColorDot
                        ...
                        onChange={(c) =>
                          updateCollection(collection.id, { color: c })
                        }
                      />
