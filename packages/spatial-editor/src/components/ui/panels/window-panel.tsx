...
export function WindowPanel() {
  ...
  if (!node || node.type !== "window" || selectedIds.length !== 1) {
    return null;
  }
      ...
      <PanelSection title="Grid">
        <SliderControl
          ...
          onChange={(v) => {
            ...
            handleUpdate({ columnRatios: new Array(n).fill(1 / n) });
          }}
          precision={0}
          step={1}
          value={numCols}
        ...
        <SliderControl
          ...
          onChange={(v) => {
            const n = Math.max(1, Math.min(8, Math.round(v)));
            handleUpdate({ rowRatios: new Array(n).fill(1 / n) });
          }}
          precision={0}
          step={1}
          value={numRows}
          ...
          <div className="mt-2 flex flex-col gap-1">
            ...
            <div className="mt-1 border-border/50 border-t pt-1">
              <SliderControl
                ...
                unit="m"
                value={
                  Math.round((node.columnDividerThickness ?? 0.03) * 1000) /
                  1000
                }
              />
            </div>
          ...
          <div className="mt-2 flex flex-col gap-1">
            ...
            <div className="mt-1 border-border/50 border-t pt-1">
              <SliderControl
                ...
                unit="m"
                value={
                  Math.round((node.rowDividerThickness ?? 0.03) * 1000) / 1000
                }
              />
            </div>
          </div>
