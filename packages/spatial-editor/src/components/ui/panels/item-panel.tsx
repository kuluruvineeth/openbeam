...
export function ItemPanel() {
  ...
  if (!node || node.type !== "item" || selectedIds.length !== 1) {
    return null;
  }
    ...
    >
      <PanelSection title="Position">
        <SliderControl
          ...
          onChange={(value) =>
            handleUpdate({
              position: [value, node.position[1], node.position[2]],
            })
          }
          precision={2}
          step={0.01}
        ...
        <SliderControl
          ...
          onChange={(value) =>
            handleUpdate({
              position: [node.position[0], value, node.position[2]],
            })
          }
          precision={2}
          step={0.01}
        ...
        <SliderControl
          ...
          onChange={(value) =>
            handleUpdate({
              position: [node.position[0], node.position[1], value],
            })
          }
          precision={2}
          step={0.01}
        ...
        {uniformScale ? (
          ...
          <>
            <SliderControl
              ...
              onChange={(value) =>
                handleUpdate({
                  scale: [Math.max(0.01, value), node.scale[1], node.scale[2]],
                })
              }
              precision={2}
              step={0.1}
            ...
            <SliderControl
              ...
              onChange={(value) =>
                handleUpdate({
                  scale: [node.scale[0], Math.max(0.01, value), node.scale[2]],
                })
              }
              precision={2}
              step={0.1}
            ...
            <SliderControl
              ...
              onChange={(value) =>
                handleUpdate({
                  scale: [node.scale[0], node.scale[1], Math.max(0.01, value)],
                })
              }
              precision={2}
              step={0.1}
