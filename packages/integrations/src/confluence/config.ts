...
export const confluenceApp: UnifiedApp = {
  ...
  features: [
    "Semantic search across wiki pages, blog posts, and comments",
    "Incremental sync via CQL timestamp filtering",
    "Space-level filtering and permissions",
    "Comment indexing for full page context",
  ...
  streams: [
    ...
    },
    {
      name: "comments",
      label: "Comments",
      description: "Footer comments on pages and blog posts",
      entityType: "activity",
      dataPoints: ["Body", "Author", "Page", "Space"],
      isPii: false,
      syncMode: SyncMode.PERIODIC,
      defaultInterval: 15,
      supportsBackfill: true,
  ...
  settings: [
    ...
    },
    {
      id: "sync_comments",
      label: "Sync Comments",
      description: "Index page and blog post comments as separate documents.",
      type: "switch",
      required: false,
      value: true,
    },
    {
      id: "labels_filter",
      label: "Labels Filter",
      description: "Only sync pages with these labels. Leave empty for all.",
      type: "text",
      required: false,
      value: "",
      placeholder: "engineering, runbook",
    },
    {
      id: "sync_archived",
      label: "Sync Archived",
